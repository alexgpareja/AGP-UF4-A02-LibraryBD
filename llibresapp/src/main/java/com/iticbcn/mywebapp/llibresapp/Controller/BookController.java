...
import com.iticbcn.mywebapp.llibresapp.Model.RepoLlibre;
...
public class BookController {
    ...
    @PostMapping("/")
    public String login(Model model, @RequestParam String usuari, @RequestParam String contrasenya) {
        if (usuari.equals("usuari") && contrasenya.equals("contrasenya")) {
            return "consulta";
        } else {
